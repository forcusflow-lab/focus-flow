...
describe("v11 Widgetのサイズ・単一リストカード・必須表示契約", () => {
  it("リサイズCallbackの現在optionsから小・標準・大を1/2/3行へ切り替える", () => {
  ...
  it("Todo・習慣・Todayの必須Pillは単独行と十分な幅を持つ", () => {
    ...
    expect(today).toContain('meta: { minHeight: 48, flexDirection: "column"');

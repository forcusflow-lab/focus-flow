    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onComplete}>
      <View style={styles.backdrop}>
        <View style={styles.sheet}>
          ...
          <View style={styles.progressRow}>{steps.map((_, index) => <View key={index} style={[styles.progressDot, index <= step && styles.progressDotActive]} />)}</View>
...
const styles = StyleSheet.create({
  ...
  progressRow: { flexDirection: "row", gap: 6, marginBottom: 21 }, progressDot: { flex: 1, height: 4, borderRadius: 2, backgroundColor: "#E5ECE8" }, progressDotActive: { backgroundColor: COLORS.forest },

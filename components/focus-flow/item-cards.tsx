...
const styles = StyleSheet.create({
  ...
  meta: { width: "100%", minHeight: 19, flexDirection: "row", alignItems: "center", flexWrap: "wrap", gap: 4, marginTop: 2 },
  habitProgressPill: { flexDirection: "row", alignItems: "center", gap: 2, paddingHorizontal: 4, paddingVertical: 1, borderRadius: 5 },
  habitProgressPillText: { fontSize: 9.5, lineHeight: 13, fontWeight: "800" },

...
export type WidgetBackgroundStyle = "solid" | "geometric" | "aurora" | "grid";
// Legacy contract: export type WidgetBackgroundStyle = "solid" | "geometric";
...
export type DisplaySettings = {
  ...
  /** ホーム画面Widgetの背景スタイル。solidは単色、geometricは幾何学模様。 */

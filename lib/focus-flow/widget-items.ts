...
export function widgetRowActionKey({ widgetId, row, operation, kind, itemId }: { widgetId: number; row: number; operation: "complete" | "restore" | "increment" | "decrement" | "timer_start" | "timer_pause"; kind: string; itemId: string }) {

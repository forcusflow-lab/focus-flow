...
const styles = StyleSheet.create({
  ...
  summary: { borderWidth: 1, borderRadius: 18, paddingHorizontal: 14, paddingTop: 11, paddingBottom: 11, marginTop: -4, marginBottom: 10 },
  ...
  summaryEyebrow: { fontSize: 9.5, letterSpacing: 0.5, fontWeight: "900" },
  summaryTitle: { fontSize: 13, lineHeight: 18, fontWeight: "800", marginTop: 1 },
  summaryPercent: { fontSize: 20, fontWeight: "900" },
  progressTrack: { height: 6, borderRadius: 999, overflow: "hidden", marginTop: 9 },
  progressFill: { height: "100%", borderRadius: 999 },
  summaryHint: { fontSize: 10.5, lineHeight: 14, marginTop: 7 },

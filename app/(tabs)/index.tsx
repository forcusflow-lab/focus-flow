...
import { dayKey, dayKeyOffset, formatJapaneseDate, getGateRuleSummaries, getGateSummary, getRequiredWindowMode, getTodoDueStatus, habitProgressLabel, habitStreak, isHabitCompleteOn, shortWeekday, weeklyHabitProgress } from "@/lib/focus-flow/utils";
...
export default function TodayScreen() {
  ...
  const { todos, habits, memos, focusSessions, gateConfig, displaySettings, isReady, toggleTodo, toggleHabit, adjustHabitProgress, addTodo, updateTodo, updateHabit } = useFocusFlow();

...
const styles = StyleSheet.create({
  ...
  itemCard: { position: "relative", minHeight: 68, flexDirection: "row", alignItems: "center", overflow: "hidden", backgroundColor: "rgba(255,255,255,0.92)", borderWidth: 1, borderColor: COLORS.border, borderRadius: 15, paddingVertical: 8, paddingLeft: 14, paddingRight: 4, marginBottom: 6 }, requiredItemCard: { backgroundColor: "#F4FBF7", borderColor: "#B9DDD1" }, itemRail: { position: "absolute", left: 0, top: 0, bottom: 0, width: 4 }, itemCheckTouchTarget: { width: 44, height: 44, alignItems: "center", justifyContent: "center", marginLeft: -8, marginRight: 2 }, itemCheck: { width: 28, height: 28, borderRadius: 6, borderWidth: 1.5, borderColor: "#AFC0B7", alignItems: "center", justifyContent: "center" }, itemCopy: { flex: 1, minWidth: 0 }, habitTitleRow: { flexDirection: "row", alignItems: "center", gap: 7 }, habitDot: { width: 8, height: 8, borderRadius: 4, flexShrink: 0 }, itemTitle: { color: COLORS.text, fontSize: 15, lineHeight: 21, fontWeight: "800" }, meta: { minHeight: 48, flexDirection: "column", alignItems: "flex-start", gap: 2, marginTop: 4 }, itemMeta: { width: "100%", color: COLORS.muted, fontSize: 11, lineHeight: 16, fontWeight: "700" }, windowMeta: { width: "100%", color: "#7A5A22", fontSize: 11, lineHeight: 16, fontWeight: "800" }, overdue: { color: COLORS.error }, openControl: { width: 34, height: 40, alignItems: "center", justifyContent: "center", marginLeft: 2 }, todayHabitRow: { position: "relative", minHeight: 98, flexDirection: "row", alignItems: "flex-start", overflow: "hidden", borderWidth: 1, borderRadius: 15, paddingVertical: 9, paddingLeft: 14, paddingRight: 4, marginBottom: 6 }, todayHabitCopy: { flex: 1, minWidth: 0 }, todayHabitTitleDone: { color: "#75827C", textDecorationLine: "line-through", textDecorationColor: "#75827C" }, todayWeekRow: { flexDirection: "row", gap: 6, marginTop: 6 }, todayDayDot: { width: 22, height: 22, borderRadius: 11, borderWidth: 1, alignItems: "center", justifyContent: "center" }, todayDayLetter: { color: COLORS.muted, fontSize: 9, fontWeight: "800" }, todayProgressControl: { alignSelf: "flex-start", flexDirection: "row", alignItems: "center", gap: 7, borderRadius: 10, marginTop: 6, paddingHorizontal: 5, paddingVertical: 3 }, todayProgressButton: { width: 25, height: 25, alignItems: "center", justifyContent: "center", borderRadius: 7 }, todayProgressText: { minWidth: 48, textAlign: "center", fontSize: 11, fontWeight: "900" },

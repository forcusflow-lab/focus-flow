...
function withFocusFlowAndroid(config) {
  ...
  return withDangerousMod(config, ["android", async (config) => {
    ...
    for (const [directory, file] of [["layout", "focus_flow_widget.xml"], ["layout", "focus_flow_widget_progress.xml"], ["layout", "focus_flow_widget_next.xml"], ["layout", "focus_flow_widget_habit.xml"], ["layout", "focus_flow_widget_routine.xml"], ["xml", "focus_flow_accessibility_service.xml"], ["xml", "focus_flow_widget_info.xml"], ["xml", "focus_flow_widget_progress_info.xml"], ["xml", "focus_flow_widget_next_info.xml"], ["xml", "focus_flow_widget_habit_info.xml"], ["xml", "focus_flow_widget_routine_info.xml"], ["values", "focus_flow_styles.xml"], ["drawable", "focus_flow_widget_background.xml"], ["drawable", "focus_flow_widget_background_progress.xml"], ["drawable", "focus_flow_widget_background_next.xml"], ["drawable", "focus_flow_widget_background_habit.xml"], ["drawable", "focus_flow_widget_background_routine.xml"], ["drawable", "focus_flow_widget_action_background.xml"], ["drawable", "focus_flow_widget_count_background.xml"]]) { const destination = path.join(resourceTarget, directory, file); fs.mkdirSync(path.dirname(destination), { recursive: true }); fs.copyFileSync(path.join(templateRoot, "res", directory, file), destination); }

...
class FocusGateModule(private val context: ReactApplicationContext) : ReactContextBaseJavaModule(context) {
  ...
  companion object {
    const val GATE_PREFS = "FocusFlowGate"; const val GATE_STATE = "gateState"; const val GATE_STATE_UPDATED_AT = "gateStateUpdatedAt"; const val SAFETY_PAUSE_UNTIL = "safetyPauseUntil"

...
class FocusGateModule(private val context: ReactApplicationContext) : ReactContextBaseJavaModule(context) {
  ...
  companion object {
    const val GATE_PREFS = "FocusFlowGate"; const val GATE_STATE = "gateState"; const val GATE_STATE_UPDATED_AT = "gateStateUpdatedAt"; const val WIDGET_COMPLETIONS = "widgetCompletions"; const val WIDGET_UNDO = "widgetUndo"
  }
}
